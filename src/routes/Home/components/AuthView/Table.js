...
import Listeleİstasyon from "./Listeleİstasyon.js";
import {FormattedMessage, FormattedDate, FormattedNumber} from 'react-intl';
import defaultMessage  from './messages';

export const Table = ({ onViewChange }) => {
                ...
                <ul style={{ marginTop: "40px", borderRadius: "5px" }}>
                    ...
                    <li ><a href="#" onClick={e => {
                        ...
                        <ul>
                            ...
                            <li><a href="#" style={{ marginTop: "10px" }}><FormattedMessage id='passive'  defaultMessage={defaultMessage.authview.passive}/> </a></li>
                            <li><a href="#" onClick={e => {
                  e.preventDefault();
                  onViewChange(8);
