...
class Map extends React.Component{
  ...
  return (
    <GoogleMap
     ...
     {this.state.data.map(row => row.sube_calisma_durumu === "PASİF" && ( 
      ...
      >
         <div className="card" style={{ width: "300px", height: "250px", backgroundColor: "#b0e0e6" }}>
            ...
            <div className="detay" style={{ marginTop: "20px" }}>
              ...
              <p><b style={{ fontWeight: "bold" }}><FormattedMessage id='fullrate'  defaultMessage={defaultMessage.authview.fullrate}/>ı:<ProgressBar message={`${selectedIstasyon.doluluk_orani}%`} height="40%" width={`${selectedIstasyon.doluluk_orani}%`} srOnly /></b></p>
...
export const PasifCapsuleView = ({ onViewChange }) => {
...
export default PasifCapsuleView;
