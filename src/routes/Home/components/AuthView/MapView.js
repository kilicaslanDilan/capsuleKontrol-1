...
export const MapView = ({ onViewChange }) => {


  return (

    <div className="sidebar" style={{ width: '100%', height: '100%', marginLeft: "225px", marginTop: "0px", backgroundColor:"#2f353a"}}>
      <div className="col-md-12 d-none d-md-block bg-light sidebar bg-dark" style={{ width: "9000px", height: "25px", marginLeft: "0px" , backgroundColor:"#2f353a"}}>
